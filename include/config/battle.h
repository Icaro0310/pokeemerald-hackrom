...
#define B_FLAG_FORCE_DOUBLE_WILD    FLAG_UNUSED_0x025     // If this flag is set, all land and surfing wild battles will be double battles.
#define B_SMART_WILD_AI_FLAG        1     // If this flag is set, wild Pokémon will become smart, with all AI flags enabled.
#define B_SMART_TRAINER_AI_FLAG     1     // If this flag is set, all trainers will use smart AI instead of basic AI.
...
#define B_VAR_DIFFICULTY            DIFFICULTY_HARD     // If not 0, you can use this var to control which difficulty version of a Trainer is loaded. This should be manually set by the developer using Script_SetDifficulty AFTER NewGameInitData has run.
